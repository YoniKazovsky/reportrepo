...
\bibitem [BEKH]{bekh} Gabriella Bekhrad - Received help from her with figuring out LaTeX and some of its packages for drawing mathematical diagrams and expressions.
\bibitem [WEIN]{wein} Jonathan Weinberger - Course instructor
\bibitem[HOF]{hof} Douglas Hofstadter, \emph{Gödel, Escher, Bach: An Eternal Golden Braid}, Vintage Books, 1980.
\bibitem[LARK]{lark} Lark Parser Documentation, \href{https://github.com/lark-parser/lark}{https://github.com/lark-parser/lark}.
\bibitem[KURZ]{kurz} Alexander Kurz, Course Materials for CPSC 354: Programming Languages, Chapman University, 2024.
\bibitem[CHAT]{chat} Chat GPT - Used for debugging and help with latex syntax.
\end{thebibliography}
